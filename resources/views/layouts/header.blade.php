        ...
        <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle nav-link" data-toggle="dropdown" href="javascript:void(0);">Kategoriler</a>
                        <div class="dropdown-menu">
                            <ul>
                                @foreach($categories as $category)
                                    <li><a class="dropdown-item nav-link nav_item" href="{!! $category->url !!}">{!! $category->name !!}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </li>
